...
Active initiative: [Structural Authority Hardening](docs/initiatives/active/structural-authority-hardening/prd.md).
...
Current work is tightening remaining authority leaks so daily structural changes route through explicit MCP workflows instead of generic metadata, sidecar, or folder-derived paths.
...
- [Structural Authority Hardening](docs/initiatives/active/structural-authority-hardening/prd.md) — active milestone for tightening remaining target-architecture discrepancies
