...
- **Active development:** Database Backup and Recovery now has project backup export, freshness diagnostics, advisory operation history, automatic backup refresh after sanctioned project-scoped canonical mutations, and dry-run restore planning; the next slice focuses on transactional restore and rebuild.
