...
- **Active development:** Database Backup and Recovery now has project backup export, freshness diagnostics, advisory operation history, automatic backup refresh after sanctioned project-scoped canonical mutations, dry-run restore planning, and transactional restore application; the next slice focuses on deployment, documentation, and release readiness.
