...
5. `setup_prose_styleguide_skill` — generate `skills/prose-styleguide/SKILL.md`; for sync-root setup this also publishes AI boot files (`CLAUDE.md`, `.github/copilot-instructions.md`), while project-scoped runs skip boot files to avoid cross-project collisions
