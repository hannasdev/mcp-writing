...
- sidecar, world-entity, styleguide config, and AI boot writes should each get at
  least one symlink-target rejection test when moved to artifact-aware helpers;
