...
> BREAKING
>
> `describe_workflows` workflow IDs have been renamed and reordered to reflect an outcome-first, discovery-first default surface.
>
> If you have agent prompts, tool routers, or automation keyed to the previous workflow IDs, update them using this mapping:
>
> - `manuscript_exploration` -> `question_driven_discovery` (or `targeted_scene_reading` when prose inspection is the real intent)
...
>
> New workflow IDs added as part of this redesign:
>
> - `thread_understanding`
> - `parity_recovery`
>
> Styleguide workflows remain available but are intentionally de-emphasized from the primary day-to-day workflow surface.
>
> Contract note:
>
> - `find_scenes` may now return an envelope for non-paginated calls when stale-scene guidance is attached. Clients should accept both raw-array and envelope shapes for non-paginated `find_scenes` responses.
...
/pull/163)
- Release 2.18.0 [`2dbd54d`](https://github.com/hannasdev/mcp-writing.git
/commit/2dbd54db72e212840b90207a830bb6d39134f86a)
...
/pull/161)
- Release 2.17.0 [`10879b8`](https://github.com/hannasdev/mcp-writing.git
/commit/10879b8e3accf0d1af64b30ca2881c8bfe140d73)
...
/pull/145)
- Release 2.12.20 [`b61b2a3`](https://github.com/hannasdev/mcp-writing.git
/commit/b61b2a3be4d676496e8912fbf4c8e2f3b1280955)
...
- chore(ci): update GitHub Actions for Node 24 [`#115`](https://github.com/hannasdev/mcp-writing.git
/pull/115)
- Release 2.12.2 [`d7192d7`](https://github.com/hannasdev/mcp-writing.git
/commit/d7192d7d9f037be6171837cd25c3eefefa991946)
...
/pull/112)
- Release 2.12.1 [`d01b8bb`](https://github.com/hannasdev/mcp-writing.git
/commit/d01b8bb1eb9af829b9e70db15bbab1e4878a145f)
