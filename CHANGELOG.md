...
> Contract note:
>
> - `find_scenes` and `get_arc` now always return envelope responses (including non-paginated calls). Clients should parse these tools as envelope-only (`results`, `total_count`, plus pagination fields when present).
