export const WORKFLOW_CATALOGUE = [
  ...
  },
  {
    ...
    steps: [
      ...
      { tool: "connect_character_place_evidence", note: "Use only when a scene proves paired sheet-backed character/place evidence; SQLite scene relationship indexes commit first and sidecar characters/places remain generated compatibility output. Character-only or place-only scene evidence needs a deliberately named future workflow." },
