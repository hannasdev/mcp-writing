export const WORKFLOW_CATALOGUE = [
  ...
  },
  {
    ...
    steps: [
      ...
      { tool: "restore_project_from_backup", note: "Apply only after the dry-run plan is reviewed. Pass dry_run=false with confirm_destructive=true for deletes, and confirm_cross_scope=true for universe-scoped changes." },
